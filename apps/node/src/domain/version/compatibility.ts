  ...
  if (!receiverVariant.installed) {
    ...
    return {
      ...
      remediation: [
        ...
        `Install the matching APK: clawperator operator setup --apk operator-v${parsedCli.normalized}.apk --device-id <device_id>${operatorPackage.endsWith(".dev") ? " --receiver-package com.clawperator.operator.dev" : ""}`,
