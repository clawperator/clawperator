...
```json
{
  ...
  "remediation": [
    "Download the matching APK: https://downloads.clawperator.com/operator/v0.6.4/operator-v0.6.4.apk",
    "Download the checksum: https://downloads.clawperator.com/operator/v0.6.4/operator-v0.6.4.apk.sha256",
    "Verify the checksum: sha256sum -c operator-v0.6.4.apk.sha256",
    "Install the matching APK: clawperator operator setup --apk operator-v0.6.4.apk --device <device_id>",
