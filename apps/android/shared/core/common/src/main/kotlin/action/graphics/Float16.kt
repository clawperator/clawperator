...
import action.graphics.Float16.Companion.MaxExponent
import action.graphics.Float16.Companion.MinExponent
import action.graphics.Float16.Companion.NaN
import action.graphics.Float16.Companion.NegativeInfinity
import action.graphics.Float16.Companion.NegativeZero
import action.graphics.Float16.Companion.PositiveInfinity
import action.graphics.Float16.Companion.PositiveZero
...
internal value class Float16(
    ...
    companion object {
        ...
        private fun toCompareValue(value: Short): Int =
            if (value.toInt() and FP16_SIGN_MASK != 0) {
