...
| R10 | [Sensitive hierarchy access](../../../docs/internal/design/accessibility-hierarchy.md) | Complete | R4 merged | [DONE] implemented and locally validated; pending merge/manual release CI; pack retired; [regression harness](../../../validation/sensitive-hierarchy-access/README.md) |
...
complete; merge and a manually dispatched CI emulator run remain release prerequisites.
