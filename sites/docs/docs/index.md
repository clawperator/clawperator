...
- [Project Overview](getting-started/project-overview.md) - What Clawperator is and how it works
- [First-Time Setup](getting-started/first-time-setup.md) - Device setup and APK installation
...
- [API Overview](reference/api-overview.md) - Execution payload, action types, result envelopes
...
- [Doctor v0.1 Design Spec](design/node-doctor-design.md)
- [Operator LLM Playbook](design/operator-llm-playbook.md)
- [Skill Design](design/skill-design.md)
- [Alpha Release Checklist](design/node-api-alpha-release-checklist.md)
