...
Preserve per-step evidence and distinguish accepted actions from verified effects. This pack has one PR and one phase, and is not started. All implementation, tests, and public documentation ship together.
