...
```json
{
  ...
  "remediation": [
    "Download the matching APK: https://downloads.clawperator.com/operator/v0.7.7/operator-v0.7.7.apk",
    "Download the checksum: https://downloads.clawperator.com/operator/v0.7.7/operator-v0.7.7.apk.sha256",
    "Verify the checksum: sha256sum -c operator-v0.7.7.apk.sha256",
    "Install the matching APK: clawperator operator setup --apk operator-v0.7.7.apk --device <device_id>",
