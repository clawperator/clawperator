...
class FixedCircularArray<T> :
     ...
     */
    constructor(circularArray: FixedCircularArray<T>) {
    ...
    fun getOldest(): T = get(0)

    fun getNewest(): T = get(size - 1)
    ...
    public override fun clone(): FixedCircularArray<T> = FixedCircularArray(this)
