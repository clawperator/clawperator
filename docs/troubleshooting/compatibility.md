...
**Current release: [0.11.2](https://github.com/clawperator/clawperator/releases/tag/v0.11.2)**
...
```json
{
  ...
  "remediation": [
    "Download the matching APK: https://downloads.clawperator.com/operator/v0.11.2/operator-v0.11.2.apk",
    "Download the checksum: https://downloads.clawperator.com/operator/v0.11.2/operator-v0.11.2.apk.sha256",
    "Verify the checksum: sha256sum -c operator-v0.11.2.apk.sha256",
    "Install the matching APK: clawperator operator setup --apk operator-v0.11.2.apk --device <device_id>",
