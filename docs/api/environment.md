...
Blank or whitespace-only values are treated as unset, so the runtime falls back to the default package instead of treating an empty string as a real package id.
