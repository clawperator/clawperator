...
| `start_recording` | - | `sessionId: string` (optional; PoC-phase action, no host-side retrieval API yet) |
| `stop_recording` | - | `sessionId: string` (optional; PoC-phase action, no host-side retrieval API yet) |
