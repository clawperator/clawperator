...
This page intentionally focuses on the recording data itself. For the CLI
retrieval commands and step-log parser surface, see [Node API for
Agents](node-api-for-agents.md).
