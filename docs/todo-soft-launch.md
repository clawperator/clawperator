...
## Phase 0: Documentation Tightening [COMPLETE]
...
- [x] **Audit `docs/node-api-for-agents.md`**
...
- [x] **Create `docs/first-time-setup.md`**
...
- [x] **Move design docs to `docs/design/`**
...
## Phase 1: NPM Package Publishing [COMPLETE]
...
- [x] **Verify npm package name availability**
...
- [x] **Update `/apps/node/package.json`**
...
- [x] **Verify `/apps/node/LICENSE` exists**
