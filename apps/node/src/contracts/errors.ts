...
export const ERROR_CODES = {
  ...
  NOTIFICATION_ACTION_EXPIRED: "NOTIFICATION_ACTION_EXPIRED",
  NOTIFICATION_ACTION_CANCELLED: "NOTIFICATION_ACTION_CANCELLED",
  NOTIFICATION_ACTION_INPUT_UNSUPPORTED: "NOTIFICATION_ACTION_INPUT_UNSUPPORTED",
  NOTIFICATION_ACTION_AUTHENTICATION_UNSUPPORTED: "NOTIFICATION_ACTION_AUTHENTICATION_UNSUPPORTED",
  NOTIFICATION_MEDIA_OPERATION_FAILED: "NOTIFICATION_MEDIA_OPERATION_FAILED",
  MEDIA_POSITION_INVALID: "MEDIA_POSITION_INVALID",
  MEDIA_POSITION_OUT_OF_RANGE: "MEDIA_POSITION_OUT_OF_RANGE",
