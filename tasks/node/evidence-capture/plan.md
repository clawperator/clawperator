...
Produce reusable evidence artifacts with capture metadata and honest partial-failure reporting. This pack has two PRs, one phase per PR, and is not started. Merge PR-1 before starting PR-2.
