...
**Current release: [0.11.1](https://github.com/clawperator/clawperator/releases/tag/v0.11.1)**
...
```json
{
  ...
  "remediation": [
    "Download the matching APK: https://downloads.clawperator.com/operator/v0.11.1/operator-v0.11.1.apk",
    "Download the checksum: https://downloads.clawperator.com/operator/v0.11.1/operator-v0.11.1.apk.sha256",
    "Verify the checksum: sha256sum -c operator-v0.11.1.apk.sha256",
    "Install the matching APK: clawperator operator setup --apk operator-v0.11.1.apk --device <device_id>",
