...
export function getVideoMcpTools(session: SessionDefaults = createSessionDefaults(), dependencies: VideoDependencies = {}): McpToolDefinition[] {
  ...
  return [{ name: "evidence_video_start", description: "Start a bounded screen recording in a managed bundle; recording is startup confirmation, not verified media.",
